...
/*
Greedy wraps the text into lines that not exceed the width. It uses the greedy line-breaking algorithm.
*/
func TestGreedy(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := linebreak.Greedy(tt.args.text, tt.args.width)
